...
//       {/* Sticky Title Bar */}
//       <div className="sticky top-0 z-10 flex justify-between items-center p-4 bg-black bg-opacity-50 backdrop-blur text-white shadow-lg">
//         <h1 className="text-2xl font-bold"></h1>
//         <div>
//           <select
//             value={month}
//             onChange={e => setMonth(e.target.value)}
//             className="p-2 rounded bg-white text-black font-semibold"
//           >
...
//       <header className="max-w-5xl mx-auto mb-8 text-center text-white drop-shadow-xl mt-8">
//         <h1 className="text-5xl font-extrabold mb-2">Campus Carbon Footprint Dashboard</h1>
//         <p className="text-lg font-medium">Track, analyze, and reduce your department's carbon emissions effectively.</p>
//       </header>

//       <main className="max-w-5xl mx-auto space-y-8 pb-10">

//         {/* Emissions Bar Chart */}
//         <div className="bg-white bg-opacity-20 backdrop-blur-md rounded-lg p-6 shadow-xl text-white">
//           <h2 className="text-2xl font-bold mb-4">📊 Department Emissions (Bar Chart)</h2>
//           <DepartmentEmissionsChart month={month} />
//         </div>

//         {/* Emissions Pie Chart */}
//         <div className="bg-white bg-opacity-20 backdrop-blur-md rounded-lg p-6 shadow-xl text-white">
//           <h2 className="text-2xl font-bold mb-4">🌎 Emissions Breakdown (Pie Chart)</h2>
//           <EmissionsPieChart />
//         </div>

//         {/* Electricity Usage Pie Chart */}
//         <div className="bg-white bg-opacity-20 backdrop-blur-md rounded-lg p-6 shadow-xl text-white">
//           <h2 className="text-2xl font-bold mb-4">⚡ Electricity Usage Breakdown (Pie Chart)</h2>
//           <ElectricityPieChart />
//         </div>

//         {/* Department Table */}
//         <div className="bg-white bg-opacity-20 backdrop-blur-md rounded-lg p-6 shadow-xl text-white">
//           <h2 className="text-2xl font-bold mb-4">🏢 Department-wise Details</h2>
